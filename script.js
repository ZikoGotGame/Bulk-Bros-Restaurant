...
(function() {
    ...
    function showResults(calories) {
        results.innerHTML = `<p>Your maintenance level calories is: <strong>${(calories).toFixed(2)} </strong> calories a day.</p><a href="#" id="rs">revise</a>`;
    ...
    function submitHandler(e) {
       ...
       if(form.gender.value == 'Female') {
         ...
         calories = 1355.09 + (9.56 * weight) + (1.84 * heightCM) - (4.67 * age);
        }  else {
         calories = 800.47 + (13.75 * weight) + (5 * heightCM) - (6.75 * age);
        }
